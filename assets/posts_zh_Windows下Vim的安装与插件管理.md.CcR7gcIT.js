import{_ as s,o as a,c as p,a4 as e}from"./chunks/framework.DhK2PUwq.js";const m=JSON.parse('{"title":"Windows下Vim的安装与插件管理","description":"","frontmatter":{"title":"Windows下Vim的安装与插件管理","date":"2020-02-04T15:37:07.000Z","toc":true,"tags":["Vim","Windows","Vundle"]},"headers":[],"relativePath":"posts/zh/Windows下Vim的安装与插件管理.md","filePath":"posts/zh/Windows下Vim的安装与插件管理.md"}'),l={name:"posts/zh/Windows下Vim的安装与插件管理.md"};function i(r,n,c,o,t,u){return a(),p("div",null,[...n[0]||(n[0]=[e(`<h2 id="关于vim" tabindex="-1">关于Vim <a class="header-anchor" href="#关于vim" aria-label="Permalink to &quot;关于Vim&quot;">​</a></h2><p>Vim是一款优秀的编辑器，可以在环境艰苦的纯shell端进行代码及配置文件的编辑。相比于带有GUI的vscode、notepad++等编辑器，Vim的学习成本比较高，但是却被称为“上古神器”。在Linux端<code>vi</code>、<code>vim</code>经常是修改配置文件教程的首选，Linux发行版也大都自带Vim；现在很多的Linux发行版开始自带<code>nano</code>编辑器，相比于Vim足够简单，但是所提供的功能甚少可以做简单编辑操作，对于完全无需鼠标的编辑操作Vim仍然是不二之选！</p><p>大多的Vim使用场景在Linux端，很多的教程和配置文件并不适用Windows的环境，这一路走来遇到了不少的坑。因为在学《汇编语言》下纯的shell环境相较于GUI的编辑器更能提高编辑效率，本篇心得将从Windows的环境下说明和配置Vim结构与配置文件</p><h2 id="下载与安装vim" tabindex="-1">下载与安装Vim <a class="header-anchor" href="#下载与安装vim" aria-label="Permalink to &quot;下载与安装Vim&quot;">​</a></h2><p>在GitHub仓库下的<a href="https://github.com/vim/vim-win32-installer/releases" target="_blank" rel="noreferrer">releases</a>下选择对应的<code>.exe</code>可执行文件，<code>x86</code>32位，<code>x64</code>64位。</p><blockquote><p>在Windows的环境下默认vim默认为带GUI的<code>gvim</code></p></blockquote><p>根据安装教程来，均无需修改配置，没有默认将Vim装到C盘，请尽量把软件隔离系统盘安装！这里的安装路径是<code>D:\\Vim</code></p><p>安装完成之后，在<code>D:\\Vim</code>的目录下有<code>vim82</code>和<code>_vimrc</code>两个子项，对应于linux的<code>.vim</code>和<code>.vimrc</code></p><h2 id="测试安装" tabindex="-1">测试安装 <a class="header-anchor" href="#测试安装" aria-label="Permalink to &quot;测试安装&quot;">​</a></h2><div class="language-shell line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki nord vp-code" tabindex="0"><code><span class="line"><span style="color:#616E88;"># 打开powershell</span></span>
<span class="line"><span style="color:#88C0D0;">vim</span><span style="color:#A3BE8C;"> --version</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><h2 id="基本配置-vimrc" tabindex="-1">基本配置<code>_vimrc</code> <a class="header-anchor" href="#基本配置-vimrc" aria-label="Permalink to &quot;基本配置\`_vimrc\`&quot;">​</a></h2><p>这里贴上我的基本配置文件</p><div class="language-txt line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki nord vp-code" tabindex="0"><code><span class="line"><span>&quot; Vim with all enhancements</span></span>
...
<span class="line"><span>&quot; 将你自己对非插件片段放在这行之后</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br><span class="line-number">17</span><br><span class="line-number">18</span><br><span class="line-number">19</span><br><span class="line-number">20</span><br><span class="line-number">21</span><br><span class="line-number">22</span><br><span class="line-number">23</span><br><span class="line-number">24</span><br><span class="line-number">25</span><br><span class="line-number">26</span><br><span class="line-number">27</span><br><span class="line-number">28</span><br><span class="line-number">29</span><br><span class="line-number">30</span><br><span class="line-number">31</span><br><span class="line-number">32</span><br><span class="line-number">33</span><br><span class="line-number">34</span><br><span class="line-number">35</span><br><span class="line-number">36</span><br><span class="line-number">37</span><br><span class="line-number">38</span><br><span class="line-number">39</span><br><span class="line-number">40</span><br><span class="line-number">41</span><br><span class="line-number">42</span><br><span class="line-number">43</span><br></div></div><p>在配置内容中，我额外配置的是</p><div class="language-txt line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki nord vp-code" tabindex="0"><code><span class="line"><span>&quot; 设置Vundle插件管理</span></span>
